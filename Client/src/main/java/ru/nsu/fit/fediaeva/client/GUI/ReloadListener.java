...
public class ReloadListener implements MouseListener {
    private ClientContext clientContext;
    private ClientFrame frame;

    public ReloadListener(ClientContext clientContext, ClientFrame frame) {
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        try {
            String result = sender.sendReloadRequest();
